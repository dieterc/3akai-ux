...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        // Keeps track of the viewers of the links
        var viewers = [];
        ...
        var getTypei18n = function(count) {
            if (count > 1) {
                return oae.api.i18n.translate('__MSG__LINK_PLURAL__', 'createlink');
            } else {
                return oae.api.i18n.translate('__MSG__LINK_SINGULAR__', 'createlink');
            }
        };

        /**
         * Shows a success or failure notification when the link creation has completed.
         *
        ...
        var showCompleteNotification = function(errCount) {
            ...
            var notification = oae.api.util.template().render($('#createlink-notification-template', $rootel), {
                ...
                'type': getTypei18n(addedLinks.length)
            });
