...
casper.thenOpen('http://cam.oae.com', function () {

    this.test.info("SECOND TEST");
...
casper.thenClick('#topnavigation_right_content a', function(){
    ...
    // Submit the form with only a username 
    this.test.info("     # Submit the form with only a username");
